...
const [errors, setErrors] = useState({});
  ...
  const degrees = [
    { value: "BACHELOR_OF_COMPUTER_APPLICATION", label: "Bachelor of Computer Application (BCA)" },
    { value: "BACHELOR_OF_BUSINESS_ADMINISTRATION", label: "Bachelor of Business Administration (BBA)" },
    ...
    { value: "BACHELOR_OF_TECHNOLOGY", label: "Bachelor of Technology (BTech)" },
    ...
    { value: "MASTER_OF_COMPUTER_APPLICATION", label: "Master of Computer Application (MCA)" },
    { value: "MASTER_OF_BUSINESS_ADMINISTRATION", label: "Master of Business Administration (MBA)" },
    ...
    { value: "MASTER_OF_PUBLIC_HEALTH", label: "Master of Public Health (MPH)" },
    ...
    { value: "DOCTOR_OF_BUSINESS_ADMINISTRATION", label: "Doctor of Business Administration (DBA)" },
    { value: "DOCTOR_OF_EDUCATION", label: "Doctor of Education (EdD)" },
    { value: "DOCTOR_OF_PUBLIC_HEALTH", label: "Doctor of Public Health (DrPH)" },
                ...
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <select
                      ...
                      onChange={handleChange}
                      className={`mt-1 block w-full px-3 py-2 bg-white border rounded-sm shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ${errors.month ? 'border-red-500' : 'border-gray-300'}`}
                    >
...
{formData.isGapTaken=="1" && (
  <div className="col-span-2 sm:col-span-1">
    ...
    <input
      ...
      onChange={handleChange}
      className={`mt-1 block w-full px-3 py-2 bg-white border rounded-sm shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ${errors.gapYear ? 'border-red-500' : 'border-gray-300'}`}
    />
    {errors.gapYear && <p className="text-red-500 text-sm">{errors.gapYear}</p>}
  </div>
)}
...
<div className="col-span-2 sm:col-span-1">
          ...
          <div className="flex space-x-2">
            <input
              ...
              className={`mt-1 block w-full px-3 py-2 bg-white border rounded-sm shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ${errors.certifications ? 'border-red-500' : 'border-gray-300'}`}
            />
            <button
              type="button"
