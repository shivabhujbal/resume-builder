...
function ExperienceDetails() {
  ...
  const validate = () => {
    ...
    if (formData.company.length < 3) newErrors.company = "Company name must be at least 3 characters long.";
  
    if (!formData.location) newErrors.location = "Location is required.";
    if (!/^[a-zA-Z\s]+$/.test(formData.location)) newErrors.location = "Location must only contain letters and spaces.";
    if (formData.location.length < 3) newErrors.location = "Location must be at least 3 characters long.";
    ...
    if (formData.responsibility.length === 0) newErrors.responsibility = "At least one responsibility is required.";
          ...
          <div className="container w-[1120px] h-full py-14 pl-2 pr-16">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="col-span-2 sm:col-span-1">
                  <label className="block mb-1 font-semibold text-gray-700">
                    Who did you do this for?<span className="text-red-900">*</span>
                  </label>
                  <input
                    type="text"
                    name="company"
  ...
  <div className="">
    ...
    <input
      ...
      onChange={handleChange}
      className="mt-1 block w-48 px-3 py-2 bg-white border border-gray-300 rounded-sm shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
    />
...
<div className="mt-6">
  ...
  <div className="flex space-x-2">
    <input
      ...
      className="mt-1 block w-64 px-3 py-2 bg-white border border-gray-300 rounded-sm shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
    />
    {errors.responsibility && <p className="text-red-500 text-sm">{errors.responsibility}</p>}
