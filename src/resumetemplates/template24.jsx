...
import { FaCertificate } from 'react-icons/fa'; // Import the certification icon
import img3 from '../Images/imag1.webp';

const template24 = ({ userData }) => {
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4 sm:p-8">
            <div className="bg-white shadow-lg flex flex-col lg:flex-row max-w-[210mm] lg:h-[287mm]">
                {/* Left Section */}
                <div className="w-full lg:w-1/3  text-white p-6"
                 style={{ backgroundImage: `url(${img3})` }}>
                    ...
                    {/* Contact Section */}
                    <div className="mt-8">
                        <h2 className="text-lg sm:text-xl font-bold uppercase text-red-500">Contact</h2>
                    ...
                    {/* Language Section */}
                    <div className="mt-8">
                        <h2 className="text-lg sm:text-xl font-bold uppercase text-red-500">Languages</h2>
                        <hr className="my-2 border-white" />
                        <div className="mt-4">
                    ...
                    <div className="mt-16">
                        <h2 className="text-lg sm:text-xl font-bold uppercase text-red-500">Certification</h2>
                        <hr className="my-2 border-white" />
                        <ul className="list-none">
                            {userData.educationList.flatMap((education) =>
                                education.certification.map((cert, certIndex) => (
                                    <li key={certIndex} className="mb-4 flex items-center">
                                        {/* Certification Icon */}
                                        <FaCertificate className="text-white-500 mr-2" />
                ...
                <div className="w-full lg:w-2/3 bg-white p-6 sm:p-8">
                    {/* Profile Info */}
                    <div>
                        <h2 className="text-lg sm:text-xl font-bold uppercase text-red-500">Profile Info</h2>
                    ...
                    {/* Work Experience */}
                    <div className="mt-8">
                        <h2 className="text-lg sm:text-xl font-bold uppercase text-red-500">Work Experience</h2>
                        <hr className="my-2 border-gray-300" />
                    ...
                    {/* Skills & Expertise */}
                    <div className="mt-8">
                        <h2 className="text-lg sm:text-xl font-bold uppercase text-red-500">Skills & Expertise</h2>
                        <hr className="my-2 border-gray-300" />
