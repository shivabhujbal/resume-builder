...
const Template13 = ({ userData }) => {
  return (
    <div className="flex flex-col md:flex-row bg-gray-400 p-6 md:p-10 max-w-full md:max-w-5xl mx-auto shadow-lg resume-container w-full md:w-[210mm] md:h-[287mm]">
      ...
      <div className="bg-teal-500 p-4 md:p-6 w-full md:w-1/3 text-white">
        <div className="flex flex-col items-center">
          {/* Profile Image */}
          {/* <img
            className="rounded-full w-24 h-24 md:w-32 md:h-32 object-cover mb-4 md:mb-6"
            alt={`${userData.besicDetails.first_name} ${userData.besicDetails.last_name}`}
          /> */}
          {/* Name */}
